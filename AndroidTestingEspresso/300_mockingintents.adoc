...
[source,java]
----
include::res/intents/TestIntent.javaintents/build.gradle[]
----

	
For more information see ttps://code.google.com/p/android-test-kit/wiki/EspressoIntentsSetupInstructions.
