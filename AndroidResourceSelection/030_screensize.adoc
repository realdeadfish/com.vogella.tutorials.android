...
image::deviceindependendpixels10.png[Device Independent pixels on low resolution devices,pdfwidth=60%]

Using the same number of pixels on a device with more pixels might lead to an unusable graphical user interface.
		
image::deviceindependendpixels20.png[Device independent pixels on low resolution devices,pdfwidth=60%]
