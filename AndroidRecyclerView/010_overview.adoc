...
image::listview_scheme10.png[Listview example, pdfwidth=60%]
...
image::listview_scheme20.png[Listview example,pdfwidth=60%]
...
image::listview_line10.png[Recyler view example layout,pdfwidth=60%]
